...
class CoreDataService {
    ...
    private func fetchDBChannelByID(_ identifier: String) -> ChannelDB? {
        ...
        let dbChannels: [ChannelDB] = coreDataStack.fetchData(withPredicate: predicate, inContext: coreDataStack.writeContext)
    ...
    private func fetchDBMessageByID(_ id: String) -> MessageDB? {
        ...
        let dbMessages: [MessageDB] = coreDataStack.fetchData(withPredicate: predicate)
